...
namespace ProyectMVC.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Correo,Contrasenna,Activo,Admin")] UsuarioModel usuarioModel)
        {
  ...
  public async Task<IActionResult> Login()
        ...
        [HttpPost]
        public async Task<IActionResult> Login([Bind ("Correo,Contrasenna")]UsuarioModel usuarios){

          var usuario = await _context.UsuarioModel
          .SingleOrDefaultAsync(log => log.Correo == usuarios.Correo && log
